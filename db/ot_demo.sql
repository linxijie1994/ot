...
Source Database       : ot_demo

Target Server Type    : MYSQL
Target Server Version : 50508
File Encoding         : 65001

Date: 2015-05-07 13:47:35
*/
...
-- ----------------------------
INSERT INTO `onethink_action_log` VALUES ('1', '1', '1', '2130706433', 'member', '1', 'admin在2015-03-23 09:01登录了后台', '1', '1427072491');
INSERT INTO `onethink_action_log` VALUES ('2', '1', '1', '2130706433', 'member', '1', 'admin在2015-03-23 09:03登录了后台', '1', '1427072623');
INSERT INTO `onethink_action_log` VALUES ('3', '1', '1', '2130706433', 'member', '1', 'admin在2015-03-24 17:08登录了后台', '1', '1427188104');
INSERT INTO `onethink_action_log` VALUES ('4', '1', '1', '2130706433', 'member', '1', 'admin在2015-03-24 17:16登录了后台', '1', '1427188564');
INSERT INTO `onethink_action_log` VALUES ('5', '1', '1', '2130706433', 'member', '1', 'admin在2015-04-19 10:14登录了后台', '1', '1429409672');
INSERT INTO `onethink_action_log` VALUES ('6', '1', '1', '2130706433', 'member', '1', 'admin在2015-04-28 15:21登录了后台', '1', '1430205679');
INSERT INTO `onethink_action_log` VALUES ('7', '1', '1', '2130706433', 'member', '1', 'admin在2015-04-29 13:09登录了后台', '1', '1430284154');
INSERT INTO `onethink_action_log` VALUES ('8', '10', '1', '2130706433', 'Menu', '124', '操作url：/ot/admin.php?s=/Menu/add.html', '1', '1430297972');
INSERT INTO `onethink_action_log` VALUES ('9', '10', '1', '2130706433', 'Menu', '125', '操作url：/ot/admin.php?s=/Menu/add.html', '1', '1430298006');
INSERT INTO `onethink_action_log` VALUES ('10', '10', '1', '2130706433', 'Menu', '126', '操作url：/ot/admin.php?s=/Menu/add.html', '1', '1430298058');
INSERT INTO `onethink_action_log` VALUES ('11', '10', '1', '2130706433', 'Menu', '0', '操作url：/ot/admin.php?s=/Menu/del/id/126.html', '1', '1430298090');
INSERT INTO `onethink_action_log` VALUES ('12', '10', '1', '2130706433', 'Menu', '127', '操作url：/ot/admin.php?s=/Menu/add.html', '1', '1430298113');
INSERT INTO `onethink_action_log` VALUES ('13', '10', '1', '2130706433', 'Menu', '0', '操作url：/ot/admin.php?s=/Menu/del/id/127.html', '1', '1430298128');
INSERT INTO `onethink_action_log` VALUES ('14', '10', '1', '2130706433', 'Menu', '128', '操作url：/ot/admin.php?s=/Menu/add.html', '1', '1430298153');
INSERT INTO `onethink_action_log` VALUES ('15', '1', '1', '2130706433', 'member', '1', 'admin在2015-04-30 13:06登录了后台', '1', '1430370408');
INSERT INTO `onethink_action_log` VALUES ('16', '1', '1', '2130706433', 'member', '1', 'admin在2015-05-04 15:27登录了后台', '1', '1430724454');
INSERT INTO `onethink_action_log` VALUES ('17', '1', '1', '2130706433', 'member', '1', 'admin在2015-05-04 15:32登录了后台', '1', '1430724733');
INSERT INTO `onethink_action_log` VALUES ('18', '1', '1', '2130706433', 'member', '1', 'admin在2015-05-06 15:09登录了后台', '1', '1430896180');
INSERT INTO `onethink_action_log` VALUES ('19', '1', '1', '2130706433', 'member', '1', 'admin在2015-05-06 15:09登录了后台', '1', '1430896197');
INSERT INTO `onethink_action_log` VALUES ('20', '1', '1', '2130706433', 'member', '1', 'admin在2015-05-06 15:16登录了后台', '1', '1430896585');
INSERT INTO `onethink_action_log` VALUES ('21', '1', '1', '2130706433', 'member', '1', 'admin在2015-05-06 15:17登录了后台', '1', '1430896646');
INSERT INTO `onethink_action_log` VALUES ('22', '1', '1', '2130706433', 'member', '1', 'admin在2015-05-06 15:18登录了后台', '1', '1430896728');
...
-- ----------------------------
INSERT INTO `onethink_category` VALUES ('1', 'blog', '博客', '0', '0', '10', '', '', '', '', '', '', '', '2,3', '2', '2,1', '0', '0', '1', '0', '0', '1', '', '1379474947', '1382701539', '0', '0', '');
INSERT INTO `onethink_category` VALUES ('2', 'default_blog', '默认分类', '1', '1', '10', '', '', '', '', '', '', '', '2,3', '2', '2,1,3', '0', '1', '1', '0', '1', '1', '', '1379475028', '1386839751', '0', '0', '');
...
INSERT INTO `onethink_channel` VALUES ('2', '0', '博客', 'Article/index?category=blog', '2', '1379475131', '1379483713', '0', '0');
INSERT INTO `onethink_channel` VALUES ('3', '0', '官网', 'http://www.onethink.cn', '3', '1379475154', '1387163458', '0', '0');

-- ----------------------------
-- Table structure for onethink_choice_question
-- ----------------------------
DROP TABLE IF EXISTS `onethink_choice_question`;
CREATE TABLE `onethink_choice_question` (
  ...
  `type` int(11) NOT NULL COMMENT '1-单选题，2-多选题',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4;

-- ----------------------------
-- Records of onethink_choice_question
-- ----------------------------
INSERT INTO `onethink_choice_question` VALUES ('1', '1+1=？', '2', '3', '4', '5', '6', '1', '1', '6', '5', '1430296774', '1');
INSERT INTO `onethink_choice_question` VALUES ('2', '国庆节是哪一天？', '10月1号', '5月1号', '6月1号', '11月11号', '3月8号', '4', '1', '0', '啊', '1430296887', '1');
INSERT INTO `onethink_choice_question` VALUES ('3', '题目', '答案', '1', '2', '3', '4', '4', '1', '0', 'a', '1430296947', '2');
...
-- ----------------------------
INSERT INTO `onethink_document` VALUES ('1', '1', '', 'OneThink1.1开发版发布', '2', '0', '期待已久的OneThink最新版发布', '0', '0', '2', '2', '0', '0', '0', '1', '0', '0', '11', '0', '0', '0', '1406001413', '1406001413', '1');
...
-- ----------------------------
-- Table structure for onethink_fi_question
-- ----------------------------
DROP TABLE IF EXISTS `onethink_fi_question`;
CREATE TABLE `onethink_fi_question` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `question` varchar(255) NOT NULL COMMENT '题目',
  `answer` varchar(255) NOT NULL COMMENT '答案',
  `tid` int(11) NOT NULL COMMENT '出题老师id',
  `level` int(11) NOT NULL COMMENT '试卷难度1-简单，2-一般，3-难，4-超纲',
  `unit` varchar(255) NOT NULL COMMENT '问题所属单元',
  `time` int(11) NOT NULL COMMENT '创建时间',
  `remark` text NOT NULL COMMENT '备注',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='选择题';

-- ----------------------------
-- Records of onethink_fi_question
-- ----------------------------
INSERT INTO `onethink_fi_question` VALUES ('1', '床前明月光,#,举头望明月', '疑是地上霜', '1', '1', '1', '1', '1');
...
-- ----------------------------
INSERT INTO `onethink_member` VALUES ('1', 'admin', '0', '0000-00-00', '', '60', '16', '0', '1427072464', '2130706433', '1430896728', '1');
...
INSERT INTO `onethink_menu` VALUES ('124', '试题', '0', '0', 'Papers/index', '0', '', '试题', '0', '1');
INSERT INTO `onethink_menu` VALUES ('125', '试题列表', '124', '0', 'Papers/index', '0', '', '试题列表', '0', '1');
INSERT INTO `onethink_menu` VALUES ('128', '添加试题', '124', '0', 'Papers/add', '0', '', '试题列表', '0', '1');
...
-- ----------------------------
-- Table structure for onethink_rw_question
-- ----------------------------
DROP TABLE IF EXISTS `onethink_rw_question`;
CREATE TABLE `onethink_rw_question` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `question` varchar(255) NOT NULL COMMENT '问题',
  `answer` varchar(255) NOT NULL COMMENT '答案',
  `tid` int(11) NOT NULL COMMENT '出题人id',
  `level` int(11) NOT NULL COMMENT '难度，1-简单，2-一般，3-难，4-超纲',
...
-- ----------------------------
-- Records of onethink_rw_question
-- ----------------------------
INSERT INTO `onethink_rw_question` VALUES ('1', '关关是傻逼吗？', '2', '1', '1', '4', '1430295437', '3');
INSERT INTO `onethink_rw_question` VALUES ('2', '肖哥黑吗？', '1', '1', '1', '1', '1', '1');
INSERT INTO `onethink_rw_question` VALUES ('3', '大妈是傻逼吗？', 'Y', '1', '4', '1', '1430895191', '大妈是傻逼');
INSERT INTO `onethink_rw_question` VALUES ('4', '1+1=3？', '', '1', '1', '0', '1430895392', '');
INSERT INTO `onethink_rw_question` VALUES ('5', '123', '', '1', '1', '0', '1430895763', '');
INSERT INTO `onethink_rw_question` VALUES ('6', 'R', '', '1', '1', '0', '1430897224', '');
INSERT INTO `onethink_rw_question` VALUES ('7', 'R', '', '1', '1', '0', '1430897320', '');
INSERT INTO `onethink_rw_question` VALUES ('8', 'R', '', '1', '1', '0', '1430897356', '');
INSERT INTO `onethink_rw_question` VALUES ('9', '1', 'R', '1', '1', '0', '1430897389', '');
...
-- ----------------------------
INSERT INTO `onethink_ucenter_member` VALUES ('1', 'admin', 'f62a519c50450f1a1d6c9a0744177b7d', 'fjszzzc@sina.com', '', '1427072464', '2130706433', '1430896728', '2130706433', '1427072464', '1');
...
CREATE TABLE `onethink_user` (
  ...
  `sex` int(11) NOT NULL COMMENT '性别，0-女1-男',
  `password` varchar(255) NOT NULL COMMENT '密码',
  `type` int(11) NOT NULL COMMENT '类型。0-普通用户，1-其他用户',
  `status` int(11) NOT NULL COMMENT '用户状态。0-可用，1-不可用',
...
-- ----------------------------
INSERT INTO `onethink_user` VALUES ('1', 'zzc', '1', '123123', '0', '0', '2147483647', '0', '0', '1429857630');
INSERT INTO `onethink_user` VALUES ('2', '123', '1', '123', '0', '0', '123', '0', '0', '1429857667');
INSERT INTO `onethink_user` VALUES ('3', '123', '1', '123', '0', '0', '123', '0', '0', '1429857683');
INSERT INTO `onethink_user` VALUES ('4', 'zzc1', '0', '123123', '0', '0', '2147483647', '0', '0', '1429859636');
